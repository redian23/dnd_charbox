...
var description = "Вам нравится выступать на публике. Вы знаете, как их развлечь, очаровать и даже воодушевить. " +
	...
	"Ваша музыка ободряет их или заставляет скорбеть. Ваши танцы захватывают, а шутки всегда смешны. " +
	"Чем бы вы ни занимались, ваша жизнь тесно связана с искусством."

func getBackgroundMasteryOfTools() []string {
	var musicalInstruments = []string{
		"Барабане", "Виоле", "Волынке", "Лире", "Лютне",
		"Рожке", "Свирели", "Флейте", "Цимбалах", "Гитаре",
	}
...
var artistAbility = map[string]string{
	"По многочисленным просьбам": "Вы всегда можете найти место для выступления. " +
		...
		"(в зависимости от качества заведения), если вы выступаете каждый вечер. " +

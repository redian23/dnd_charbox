...
var description = "Вы много лет плавали на морском судне. " +
	"Вы видели могучие шторма, глубоководных чудовищ и тех, кто хотел отправить вас на дно. " +
	"Первая любовь осталась далеко за горизонтом, и настало время попробовать что-то новое."
...
var backgroundAbility = map[string]string{
	"Дурная репутация": "Если у вашего персонажа предыстория моряка, можете выбрать это умение вместо умения Поездка на корабле." +
		"Где бы вы ни оказались, вас боятся из-за вашей репутации. " +
		"Находясь в цивилизованном поселении, вы можете безнаказанно совершать небольшие преступления, " +
		"такие как отказ платить за еду в таверне или выламывание двери в магазине, так как жители боятся сообщать о вас властям.",
}
...
func GetBackground() *backgrounds.Background {
	return &backgrounds.Background{
		BackgroundName:         "Pirate",
		BackgroundNameRu:       "Пират",

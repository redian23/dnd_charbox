...
func setSkillProficiency(skillsSlice []string, sk Skills) Skills {
	for _, profSkill := range skillsSlice {
		...
		case sk.Athletics.SkillName:
			...
			sk.Athletics.ModifierValue = classes.ModifierGlobal.Strength + 2
		case sk.Acrobatics.SkillName:
			sk.Acrobatics.Proficiency = true
			sk.Acrobatics.ModifierValue = classes.ModifierGlobal.Dexterity + 2
		case sk.SleightOfHand.SkillName:
			sk.SleightOfHand.Proficiency = true
			sk.SleightOfHand.ModifierValue = classes.ModifierGlobal.Dexterity + 2
		case sk.Stealth.SkillName:
			sk.Stealth.Proficiency = true
			sk.Stealth.ModifierValue = classes.ModifierGlobal.Dexterity + 2
		case sk.Arcana.SkillName:
			sk.Arcana.Proficiency = true
			sk.Arcana.ModifierValue = classes.ModifierGlobal.Intelligence + 2
		case sk.History.SkillName:
			sk.History.Proficiency = true
			sk.History.ModifierValue = classes.ModifierGlobal.Intelligence + 2
		case sk.Investigation.SkillName:
			sk.Investigation.Proficiency = true
			sk.Investigation.ModifierValue = classes.ModifierGlobal.Intelligence + 2
		case sk.Nature.SkillName:
			sk.Nature.Proficiency = true
			sk.Nature.ModifierValue = classes.ModifierGlobal.Intelligence + 2
		case sk.Religion.SkillName:
			sk.Religion.Proficiency = true
			sk.Religion.ModifierValue = classes.ModifierGlobal.Intelligence + 2
		case sk.AnimalHandling.SkillName:
			sk.AnimalHandling.Proficiency = true
			sk.AnimalHandling.ModifierValue = classes.ModifierGlobal.Wisdom + 2
		case sk.Insight.SkillName:
			sk.Insight.Proficiency = true
			sk.Insight.ModifierValue = classes.ModifierGlobal.Wisdom + 2
		case sk.Medicine.SkillName:
			sk.Medicine.Proficiency = true
			sk.Medicine.ModifierValue = classes.ModifierGlobal.Wisdom + 2
		case sk.Perception.SkillName:
			sk.Perception.Proficiency = true
			sk.Perception.ModifierValue = classes.ModifierGlobal.Wisdom + 2
		case sk.Survival.SkillName:
			sk.Survival.Proficiency = true
			sk.Survival.ModifierValue = classes.ModifierGlobal.Wisdom + 2
		case sk.Deception.SkillName:
			sk.Deception.Proficiency = true
			sk.Deception.ModifierValue = classes.ModifierGlobal.Charisma + 2
		case sk.Intimidation.SkillName:
			sk.Intimidation.Proficiency = true
			sk.Intimidation.ModifierValue = classes.ModifierGlobal.Charisma + 2
		case sk.Performance.SkillName:
			sk.Performance.Proficiency = true
			sk.Performance.ModifierValue = classes.ModifierGlobal.Charisma + 2
		case sk.Persuasion.SkillName:
			sk.Persuasion.Proficiency = true
			sk.Persuasion.ModifierValue = classes.ModifierGlobal.Charisma + 2
		}
	}

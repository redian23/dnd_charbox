...
var raceNames = map[string][]string{
	"male": {"Аукан", "Ваунеа", "Вимак", "Гае-Ал", "Иглат", "Иликан", "Кеотхи", "Куори",
		"Ло-Каг", "Мавейт", "Маннео", "Налла", "Орило", "Пааву", "Петани", "Талай", "Тхотам", "Утхал"},
	"female": {"Аукан", "Ваунеа", "Вимак", "Гае-Ал", "Иглат", "Иликан", "Кеотхи", "Куори",
		"Ло-Каг", "Мавейт", "Маннео", "Налла", "Орило", "Пааву", "Петани", "Талай", "Тхотам", "Утхал"},
}

var nickNames = map[string][]string{
	"male": {"Бесстрашный", "Встающий с рассветом", "Дважды осиротевший", "Зоркий глаз", "Искатель кремня",
	...
	"female": {"Бесстрашная", "Встающяя с рассветом", "Дважды осиротевшая", "Зоркий глаз", "Искательница кремня",
